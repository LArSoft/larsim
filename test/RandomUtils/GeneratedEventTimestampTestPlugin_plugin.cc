/**
 * @file    GeneratedEventTimestampTestPlugin_plugin.cc
 ...
 */
class GeneratedEventTimestampTestPlugin: public art::EmptyEventTimestampPlugin {
    public:
  
  /// Constructor: nothing specific
  GeneratedEventTimestampTestPlugin(fhicl::ParameterSet const& pset):
...
}; // class GeneratedEventTimestampTestPlugin
...
//------------------------------------------------------------------------------
art::Timestamp GeneratedEventTimestampTestPlugin::eventTimestamp
  (art::EventID const&)
{
  ...
  LOG_DEBUG("GeneratedEventTimestampTestPlugin")
    << "Generated time stamp: " << ts.value();
  
  return ts;
} // GeneratedEventTimestampTestPlugin::eventTimestamp()

// make art aware that we have a plugin
DEFINE_ART_EMPTYEVENTTIMESTAMP_PLUGIN(GeneratedEventTimestampTestPlugin)
