...
namespace cheat {
  ...
  public:
    ...
    std::vector<const simb::MCParticle*> MCTruthToParticles(
    ...
    const std::vector<std::vector<art::Ptr<recob::OpHit>>> TrackIDsToOpHits(
  ...
  private:
    ...
    std::vector<art::Ptr<sim::OpDetBacktrackerRecord>>
      cOpDetBacktrackerRecords;                ///< all the OpDetBacktrackerRecords for the event
