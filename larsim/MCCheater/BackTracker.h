  ...
  class BackTracker{
    public:
      ...
      struct fhiclConfig{
        ...
        fhicl::Atom<art::InputTag> SimChannelModuleLabel{fhicl::Name("SimChannelModuleLabel"), fhicl::Comment("The label of the module containing the sim::SimChannel product."), "largeant"};
