...
namespace cheat {
  ...
  //----------------------------------------------------------------
  const art::Ptr<sim::OpDetBacktrackerRecord> PhotonBackTracker::FindOpDetBTR(
    int const& opDetNum) const
  {
  ...
  //----------------------------------------------------------------
  const std::vector<sim::TrackSDP> PhotonBackTracker::OpDetToTrackSDPs(
    int const& OpDetNum,
  ...
  //----------------------------------------------------------------
  const std::vector<sim::TrackSDP> PhotonBackTracker::OpHitToTrackSDPs(
  ...
  //----------------------------------------------------------------
  const std::vector<int> PhotonBackTracker::OpHitToTrackIds(
    art::Ptr<recob::OpHit> const& opHit) const
  {
  ...
  //----------------------------------------------------------------
  const std::vector<int> PhotonBackTracker::OpHitToEveTrackIds(
  ...
  //----------------------------------------------------------------
  const std::vector<sim::TrackSDP> PhotonBackTracker::OpHitToEveTrackSDPs(
    art::Ptr<recob::OpHit> const& opHit_P) const
  {
  ...
  const std::vector<art::Ptr<recob::OpHit>> PhotonBackTracker::TrackIdToOpHits_Ps(
    int const& tkId,
    std::vector<art::Ptr<recob::OpHit>> const& hitsIn)
  {
    ...
    const std::vector<art::Ptr<recob::OpHit>> out =
      (this->TrackIdsToOpHits_Ps(tkidFake, hitsIn)).at(0);
    return out;
  }

  //----------------------------------------------------------------
  const std::vector<std::vector<art::Ptr<recob::OpHit>>> PhotonBackTracker::TrackIdsToOpHits_Ps(
  ...
  //----------------------------------------------------------------
  const std::vector<const sim::SDP*> PhotonBackTracker::OpHitToSimSDPs_Ps(
    recob::OpHit const& opHit) const
  {
  ...
  //----------------------------------------------------------------
  const std::vector<double> PhotonBackTracker::SimSDPsToXYZ(
  ...
  const std::vector<const sim::SDP*> PhotonBackTracker::OpHitsToSimSDPs_Ps(
  ...
  //----------------------------------------------------------------
  const std::vector<double> PhotonBackTracker::OpHitsToXYZ(
    std::vector<art::Ptr<recob::OpHit>> const& opHits_Ps) const
  {
  ...
  //----------------------------------------------------------------
  const std::unordered_set<const sim::SDP*> PhotonBackTracker::OpHitToEveSimSDPs_Ps(
  ...
  //----------------------------------------------------------------
  const std::set<int> PhotonBackTracker::GetSetOfEveIds(
    std::vector<art::Ptr<recob::OpHit>> const& opHits_Ps) const
  {
    std::set<int> eveIds;
  ...
  //----------------------------------------------------------------
  const std::set<int> PhotonBackTracker::GetSetOfEveIds(
    std::vector<recob::OpHit> const& opHits) const
  { /*NEW*/ /*COMPLETE*/
    std::set<int> eveIds;
  ...
  //----------------------------------------------------------------
  const std::set<int> PhotonBackTracker::GetSetOfTrackIds(
  ...
  //----------------------------------------------------------------
  const double PhotonBackTracker::OpHitCollectionPurity(
  ...
  //----------------------------------------------------------------
  const double PhotonBackTracker::OpHitLightCollectionPurity(
    std::set<int> const& tkIds,
    std::vector<art::Ptr<recob::OpHit>> const& opHits)
  {
    // get the list of EveIDs that correspond to the opHits in this collection
  ...
  //----------------------------------------------------------------
  const double PhotonBackTracker::OpHitCollectionEfficiency(
    std::set<int> const& tkIds,
    std::vector<art::Ptr<recob::OpHit>> const& opHits,
  ...
  //----------------------------------------------------------------
  const double PhotonBackTracker::OpHitLightCollectionEfficiency(
    std::set<int> const& tkIds,
    std::vector<art::Ptr<recob::OpHit>> const& opHits,
    std::vector<art::Ptr<recob::OpHit>> const& opHitsIn,
    geo::View_t const& view)
  ...
  //--------------------------------------------------
  const std::vector<art::Ptr<recob::OpHit>> PhotonBackTracker::OpFlashToOpHits_Ps(
