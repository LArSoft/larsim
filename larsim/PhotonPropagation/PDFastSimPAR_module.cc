...
namespace phot
{
  ...
  void PDFastSimPAR::produce(art::Event& event)
  {
    ...
    for (auto const& edepi: *edeps) {
      ...
      for(size_t channel = 0; channel < nOpChannels; channel ++) {
        ...
        if (nphot_fast > 0) {
          auto n = VUVHits(nphot_slow, ScintPoint,
  ...
  void PDFastSimPAR::Initialization()
  {
    ...
    if(pvs->IncludePropTime()) {
      ...
      // has been generated
      int num_params = (fmax_d - 25) / fstep_size;  // for d < 25cm, no parameterisaton, a delta function is used instead // TODO: unhardcode
  ...
  //......................................................................
  void PDFastSimPAR::propagationTime(std::vector<double>& arrival_time_dist, G4ThreeVector x0,
  ...
  void PDFastSimPAR::getVUVTimes(std::vector<double>& arrivalTimes, double distance)
  {
