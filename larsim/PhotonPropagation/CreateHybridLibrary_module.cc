...
namespace phot
{
  ...
  { 
    ...
    for(unsigned int opdetIdx =0; opdetIdx < 2; ++opdetIdx){ //geom->NOpDets(); ++opdetIdx){
	...
	if(240-3.797 <v.ex && v.ex <= 240+3.797){
	  if(opdetvec[2]-2.911 <v.ez && v.ez <= opdetvec[2]+2.911){
	...
	h.Fill(chisq);
      ...
      //g3.GetXaxis()->SetRangeUser(2715000,2719000);
      g6.GetYaxis()->SetRangeUser(0,0.004);
      ...
      //g3.GetXaxis()->SetRangeUser(2715000,2719000);
      g9.GetYaxis()->SetRangeUser(0,0.0016);
