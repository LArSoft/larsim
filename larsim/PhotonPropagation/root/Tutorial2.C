void Tutorial2()
{
  //for (int integer =2; integer <49 ; integer++){ 
    ...
    TH2D* hist1 = (TH2D*) hyb->Get("analyze/projZ230");
    ...
    hist1->Draw("colz");
    hist1->SetTitle("Hybrid Library Zproj_230 without FC");
    ...
    hist2->SetTitle("Standard Library Zproj_230 without FC");
    ...
    hist3->SetTitle("Ratio Hybrid/Std Library without FC Zproj_230");
    ...
    c1->SaveAs("Zplots_hyb_vs_std/Zproj_230.png");
    delete c1;
    //}
}
