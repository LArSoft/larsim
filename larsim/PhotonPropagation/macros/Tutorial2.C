void Tutorial2()
{
  //for (int integer =2; integer <49 ; integer++){ 
    ...
    hist1->Draw("colz");
    hist1->SetTitle("Hybrid Library Zproj_206 without FC #50");
    ...
    hist2->SetTitle("Standard Library Zproj_206 without FC #50");
    ...
    hist3->SetTitle("Ratio Hybrid/Std Library without FC Zproj_206 #50");
    ...
    c1->SaveAs("Zplots_hyb_vs_std/Zproj_206 #50.png");
    delete c1;
    //}
}
