...
TruthMatchUtils::TrueParticleID(const art::Ptr<recob::Hit>& pHit, const bool rollupUnsavedIDs)
{
...
TruthMatchUtils::G4ID
TruthMatchUtils::TrueParticleIDFromTotalTrueEnergy(const std::vector<art::Ptr<recob::Hit>>& pHits,
...
TruthMatchUtils::G4ID
TruthMatchUtils::TrueParticleIDFromTotalRecoCharge(const std::vector<art::Ptr<recob::Hit>>& pHits,
                                                   const bool rollupUnsavedIDs)
{
...
TruthMatchUtils::G4ID
TruthMatchUtils::TrueParticleIDFromTotalRecoHits(const std::vector<art::Ptr<recob::Hit>>& pHits,
                                                 const bool rollupUnsavedIDs)
{
