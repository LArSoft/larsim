...
//    std::cout << "DEBUG: cReflOpDetBTRCol.size() = " << cReflectedOpDetBacktrackerRecordsCol.size() << std::endl;
  ...
  //--------------------------------------------------
  void OpDetPhotonTable::AddEnergyDeposit(int n_photon, int n_fphoton, int n_sphoton, int n_elec, double scint_yield, 
					  double energy,
  ...
  {
    fSimEDepCol[vol].emplace_back(n_photon, n_fphoton, n_sphoton, n_elec, scint_yield,
				  energy,
