...
namespace larg4 {
  ...
  public:
    ...
    HadronElasticHPPhysicsFactory()
      : CustomPhysicsFactory<G4HadronElasticPhysicsHP>("HadronElasticHP")
    {}
  ...
  public:
    ...
    HadronElasticPHPPhysicsFactory()
      : CustomPhysicsFactory<G4HadronElasticPhysicsPHP>("HadronElasticPHP")
    {}
